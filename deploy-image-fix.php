<?php
/**
 * Script de déploiement pour corriger l'image de la page d'accueil
 * À uploader sur le serveur et à exécuter via http://votresite.com/deploy-image-fix.php
 */
...
echo "<h1>Déploiement de la correction d'image</h1>";

// Chemin du fichier à modifier
$file_path = __DIR__ . '/template-parts/section-presentation.php';
...
if (file_exists($file_path)) {
    ...
    if (copy($file_path, $backup_path)) {
        echo "<p style='color: green;'>✅ Sauvegarde créée : " . basename($backup_path) . "</p>";
    }
}

// Écriture du fichier corrigé
if (file_put_contents($file_path, $corrected_content)) {
    echo "<p style='color: green; font-size: 18px;'>✅ Fichier corrigé avec succès !</p>";
    echo "<p>L'image de la page d'accueil devrait maintenant s'afficher correctement.</p>";
    echo "<p><a href='/'>Voir la page d'accueil</a></p>";
} else {
...
echo "<p>Pour des raisons de sécurité, veuillez supprimer ce fichier après utilisation :</p>";
echo "<code><pre>rm " . __FILE__ . "</pre></code>";
