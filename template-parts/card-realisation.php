...
<article class="realisation-card <?php echo esc_attr($term_classes); ?>" data-categories="<?php echo esc_attr($term_classes); ?>">
    ...
    <div class="realisation-content">
        ...
        <?php if ($args['show_cta']) : ?>
            <a href="<?php the_permalink(); ?>" class="card-cta-link">
                <span class="card-cta-text"><?php _e('Découvrir le projet', 'almetal'); ?></span>
                <svg class="card-cta-arrow" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
