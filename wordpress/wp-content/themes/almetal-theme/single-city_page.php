...
<main class="city-page-main">
    ...
    <section class="city-hero">
        <div class="city-hero__background">
            <?php if (has_post_thumbnail()) : ?>
                <?php the_post_thumbnail('full', array('class' => 'city-hero__image')); ?>
            <?php else : ?>
        ...
        <div class="container">
            <div class="city-hero__content">
                ...
                <h1 class="city-hero__title">
                    Métallier Soudeur à <span class="highlight"><?php echo esc_html($city_display); ?></span>
                </h1>
